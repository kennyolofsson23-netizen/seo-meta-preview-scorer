...
describe('ScoreDashboard', () => {
  describe('renders all sections', () => {
    it('renders the overall score gauge', () => {
      render(<ScoreDashboard title="Good Title Here" description={repeat('A', 155)} keyword="test" />)
  ...
  describe('score color coding', () => {
    ...
    it('shows error badge for too-short description (<120 chars)', () => {
      render(
        <ScoreDashboard title="A perfect title for testing" description="Short" keyword="" />
      )
      expect(screen.getByText('Warning')).toBeInTheDocument()
    })

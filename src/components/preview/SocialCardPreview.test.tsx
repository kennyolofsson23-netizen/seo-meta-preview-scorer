...
describe("SocialCardPreview", () => {
  ...
  it("uses ogTitle instead of title when ogTitle is provided", () => {
    render(<SocialCardPreview {...defaultProps} ogTitle="OG Specific Title" />);
  ...
  it("falls back to description when ogDescription is not provided", () => {
    ...
    expect(
      screen.getByText("My page description text here"),
    ).toBeInTheDocument();
  });
  ...
  it("uses ogDescription when provided", () => {
    ...
    expect(
      screen.queryByText("My page description text here"),
    ).not.toBeInTheDocument();
  });

  it("shows domain extracted from URL", () => {
    render(
      <SocialCardPreview {...defaultProps} url="https://mywebsite.com/page" />,
    );

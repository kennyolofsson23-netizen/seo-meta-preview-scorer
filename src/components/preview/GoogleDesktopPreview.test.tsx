...
describe('GoogleDesktopPreview', () => {
  const defaultProps = {
    ...
    description: 'This is an example meta description that helps visitors understand the page.',
  ...
  it('has proper aria label', () => {
    ...
    const el = container.querySelector('[aria-label="Google search result preview"]')

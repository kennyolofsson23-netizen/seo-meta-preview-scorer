...
export function GoogleDesktopPreview({
  ...
  const truncatedDescription = truncateGoogleDesktopDescription(displayDescription)
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-1">
        {/* Favicon placeholder */}
        <div className="w-4 h-4 rounded-full bg-[#E8EAED] flex-shrink-0" aria-hidden="true" />
        <div className="text-sm leading-none" style={{ fontFamily: 'Arial, sans-serif' }}>

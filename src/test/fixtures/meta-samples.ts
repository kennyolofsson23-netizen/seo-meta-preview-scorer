...
export const SAMPLE_TITLES = {
  ...
  slightlyLong:
    "The Ultimate Guide to SEO Optimization for Small Business Websites 2024",
  tooLong:
...
export const COMPLETE_METADATA_SAMPLES = {
  ...
  googleDesktopTruncated: {
    title:
      "This title is definitely going to be truncated by Google desktop SERP results page",
    description:

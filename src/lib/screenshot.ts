...
export async function captureAndDownload(
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Screenshot failed. Please try again.',
    }
  }
}
...
function addWatermark(ctx: CanvasRenderingContext2D, canvasWidth: number): void {
  ...
  ctx.fillRect(0, ctx.canvas.height - watermarkHeight, canvasWidth, watermarkHeight)

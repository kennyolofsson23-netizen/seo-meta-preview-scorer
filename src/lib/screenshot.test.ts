...
vi.spyOn(document.body, 'appendChild').mockImplementation(mockAppendChild as typeof document.body.appendChild)
vi.spyOn(document.body, 'removeChild').mockImplementation(mockRemoveChild as typeof document.body.removeChild)
...
describe('screenshot', () => {
  ...
  it('returns failure when html2canvas throws', async () => {
    ...
    vi.mocked(html2canvasMock.default).mockRejectedValueOnce(new Error('Canvas error'))
